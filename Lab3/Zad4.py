...
S25 = [1, 2, 3, 6, 10, 17, 25, 29, 30, 41, 51, 60, 70, 79, 80, 82, 86, 90, 94, 100, 106, 108, 110, 120, 138]
S35 = [1, 2, 3, 6, 10, 17, 25, 29, 30, 41, 51, 60, 70, 79, 80, 82, 86, 90, 94, 100, 106, 108, 110, 120, 140, 131, 133,
       138, 142, 160, 180, 190, 200, 201, 207]
S45 = [1, 2, 3, 6, 10, 17, 27, 29, 30, 41, 51, 60, 70, 79, 80, 82, 86, 90, 94, 100, 106, 108, 110, 120, 140, 131, 133,
       138, 142, 160, 180, 190, 200, 201, 202, 203, 204, 205, 210, 220, 230, 240, 242, 243, 250,]

measuredTimes = []
quantityOfElments = [len(S25), len(S35), len(S45)]

#Wspolne parametry dla wszystkich zbiorów
gene_space = [0, 1]
sol_per_pop = 10
...
print("-----------------------------------")
print("Pomierzone srednie czasy dzialania programu: " + str(measuredTimes))
